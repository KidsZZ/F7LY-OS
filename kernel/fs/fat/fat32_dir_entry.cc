//
// Copied from Li Shuang ( pseudonym ) on 2024-05-16 
// --------------------------------------------------------------
...
namespace fs
{
	namespace fat
	{
		...
		{
			Info( "Fat32DirEntry constructor invoked." );
		}
		...
		Fat32DirEntryStatus Fat32DirEntry::init( uint cluster_number, Fat32DirType dir_type )
		{
			...
			// printfBlue( "debug print root clusters number:" );
			...
			if ( dir_type == fat32de_folder )
			{
				...
				// printfBlue( "debug print files under root." );
				// printf( "list /* \n" );
				// uint cnt = 0;
				// char padding[] = "                    ";
				...
				// printfBlue( "debug print files start cluster." );
				// char padding[] = "                    ";
				// uint width = sizeof( padding ) - 1;
